...
+
请参见 link:task-manage-cloud-volumes-gcp-snapshots.html#create_or_modify_a_snapshot_policy["创建快照策略"^] 有关快照功能的详细信息。
...
继续 link:task-manage-cvs-gcp.html#mount-the-cloud-volume["挂载云卷"]。
